...
| IDE | MCP | JSON 配置 | 说明 |
|:---|:---:|:---|:---|
| **[Claude code](https://docs.claude.com/en/docs/claude-code/settings)** | **api** | `"C:\Users\Administrator\.claude\settings.json"  "C:\Users\ａ\.claude.json"` | Mac: `/Users/Name/Docs`<br>Win: `C:\Users\Name\Docs` |
